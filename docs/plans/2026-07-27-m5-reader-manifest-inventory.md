...
| `core/repair.rs:1495` | `prepare_rename_page_title` | `private` | internal-only |
| `core/repair.rs:3523` | `capture_rename_page_row_on_snapshot` | `private` | internal-only |
| `core/repair.rs:3752` | `validate_rename_page_title_collision_on_snapshot` | `private` | internal-only |
| `core/repair.rs:3796` | `validate_rename_page_title_collision_on_connection` | `pub(crate)` | internal-only |
| `core/repair.rs:5738` | `projection_page_receipt_sql` | `private` | internal-only |
...
| `core/repair.rs:1365` | `prepare_memory_reclassification_with_pages` | `pub` | `prepare_rename_page_title` |
| `core/repair.rs:2092` | `apply_repair_with_pages_inner` | `private` | `apply_deterministic_repair_cas` |
| `core/repair.rs:5703` | `projection_page_row_from_snapshot` | `private` | `projection_page_receipt_sql` |
| `core/repair.rs:5722` | `projection_page_row_from_connection` | `private` | `projection_page_receipt_sql` |
...
| `core/repair.rs:1356` | `prepare_memory_reclassification` | `pub` | `prepare_memory_reclassification_with_pages` |
| `core/repair.rs:2055` | `apply_repair_with_pages` | `pub` | `apply_repair_with_pages_inner` |
| `core/repair.rs:2367` | `apply_rename_page_title` | `private` | `rename_page_title_cas` |
| `core/repair.rs:5424` | `capture_page_projection_rollback` | `pub(crate)` | `projection_page_row_from_snapshot` |
| `core/repair.rs:5564` | `projection_page_row_on_connection` | `pub(crate)` | `projection_page_row_from_connection` |
