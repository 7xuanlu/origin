...
- **`GET /api/activities` → `yes`.** `agent_activity.detail` carries page
  ...
  `handle_list_activities` (`server/memory_routes.rs:2687`). The original
...
- **`GET /api/memory/nurture` → `yes`.** `handle_get_nurture_cards`
  (`server/memory_routes.rs:1932`) → `get_nurture_cards_scoped`
...
- **`GET /api/memory/recent` → `yes`.** `handle_recent_memories`
  (`server/memory_routes.rs:4010`) → `list_recent_memories_scoped`
...
- **`GET /api/memory/unconfirmed` → `yes`.**
  `handle_list_unconfirmed_memories` (`server/memory_routes.rs:4046`) →
...
- **`GET /api/indexed-files` → `yes`.** `handle_list_indexed_files`
  (`server/memory_routes.rs:2399`) → `list_indexed_files_scoped`
...
- **`GET /api/briefing` → `yes`.** `handle_get_briefing`
  (`server/memory_routes.rs:3292`) → `generate_briefing_scoped`
...
- **`GET /api/memory/{id}/revisions` → `yes`.** `handle_get_memory_revisions`
  (`server/memory_routes.rs:5639`) → `walk_supersede_chain_scoped`
...
- **`GET /api/memory/{id}/versions` → `yes`.** `handle_get_version_chain`
  (`server/memory_routes.rs:2931`) → `get_version_chain_scoped`
...
- **`POST /api/memory/list` → `yes`.** `handle_list_memories`
  (`server/memory_routes.rs:1107`) → `list_filtered_confirmed_scoped`
  (`db.rs:29220`), which pushes `pending_revision = 0` at `db.rs:29274`. The
  handler forwards `req.confirmed` unchanged (`server/memory_routes.rs:1124`),
...
- **`GET /api/memory/by-ids` → `yes`.** `handle_get_memories_by_ids`
  (`server/memory_routes.rs:2902`) → `get_memories_by_source_ids_scoped`
...
- **`GET /api/memory/{id}/detail` → `yes`.** `handle_get_memory_detail`
  (`server/memory_routes.rs:2877`) → `get_memory_detail_scoped`
...
- **`GET /api/memory/pinned` → `yes`.** `handle_list_pinned_memories`
  (`server/memory_routes.rs:3378`) → `list_pinned_memories_scoped`
...
- **`GET /api/home-stats` → `yes`, and its gate is not the one the tier name
  suggests.** `handle_get_home_stats` (`server/memory_routes.rs:1537`) →
...
|---|---|---|---|
| `core/db.rs:3610` | `run_migrations` | `pub` | internal-only |
| `core/db.rs:9102` | `migrate_89_page_kind_fold` | `private` | internal-only |
| `core/db.rs:17042` | `reconcile_entity_page_parity` | `pub` | **exposure** — `server/scheduler.rs:2237` |
| `core/db.rs:26671` | `rebind_source_page_in_transaction` | `private` | internal-only |
| `core/db.rs:34310` | `oldest_active_page` | `pub` | internal-only |
| `core/db.rs:39506` | `list_recent_retrievals` | `pub` | internal-only |
| `core/db.rs:39646` | `list_recent_retrievals_scoped` | `pub` | **exposure** — `server/routes.rs:910` |
| `core/db.rs:39852` | `list_recent_changes` | `pub` | internal-only |
| `core/db.rs:40155` | `list_recent_pages_with_badges` | `pub` | internal-only |
| `core/db.rs:41068` | `append_page_history` | `private` | internal-only |
| `core/db.rs:41229` | `insert_page_with_kind_inner` | `private` | internal-only |
| `core/db.rs:41766` | `get_page_inner` | `private` | internal-only |
| `core/db.rs:41795` | `get_page_by_entity` | `pub` | internal-only |
| `core/db.rs:41870` | `list_pages_inner` | `private` | internal-only |
| `core/db.rs:41903` | `list_pages_stale` | `pub` | internal-only |
| `core/db.rs:41948` | `list_pages_by_space` | `pub` | internal-only |
| `core/db.rs:43009` | `find_matching_page` | `pub` | internal-only |
| `core/db.rs:43066` | `find_matching_page_scoped` | `pub` | internal-only |
| `core/db.rs:43433` | `page_merge_row` | `private` | internal-only |
| `core/db.rs:43482` | `load_page_source_index` | `pub` | **exposure** — `server/routes.rs:655` |
| `core/db.rs:43616` | `list_active_page_titles_scoped` | `pub` | internal-only |
| `core/db.rs:43663` | `list_relevant_active_page_titles` | `pub` | internal-only |
| `core/db.rs:43730` | `find_active_page_id_by_title` | `pub` | internal-only |
| `core/db.rs:43765` | `find_unique_active_page_id_by_title_scoped` | `pub` | internal-only |
| `core/db.rs:44316` | `backfill_page_embeddings` | `pub` | internal-only |
| `core/db.rs:45394` | `get_pages_for_memory` | `pub` | internal-only |
| `core/db.rs:46293` | `get_stale_page_after` | `pub` | internal-only |
| `core/db.rs:46330` | `list_stale_pages_scoped` | `pub` | **exposure** — `server/routes.rs:734` |
| `core/db.rs:46370` | `find_stale_archived_pages` | `pub` | **exposure** — `server/cmd_backfill.rs:49` |
...
| `core/db/repair_page_rename.rs:717` | `page_on_connection` | `private` | internal-only |
...
| `core/repair.rs:1441` | `prepare_rename_page_title` | `private` | internal-only |
| `core/repair.rs:3796` | `capture_rename_page_row_on_snapshot` | `private` | internal-only |
| `core/repair.rs:4025` | `validate_rename_page_title_collision_on_snapshot` | `private` | internal-only |
| `core/repair.rs:4069` | `validate_rename_page_title_collision_on_connection` | `pub(crate)` | internal-only |
| `core/repair.rs:6011` | `projection_page_receipt_sql` | `private` | internal-only |
...
|---|---|---|---|
| `core/db.rs:3271` | `new` | `pub` | `run_migrations` |
| `core/db.rs:3483` | `new_with_shared_embedder` | `pub` | `run_migrations` |
| `core/db.rs:24133` | `augment_with_graph_gated` | `private` | `search_entities_by_vector_scoped` |
| `core/db.rs:26211` | `rebind_source_id_inner` | `private` | `rebind_source_page_in_transaction` |
| `core/db.rs:41159` | `insert_page_with_kind` | `pub(crate)` | `insert_page_with_kind_inner` |
| `core/db.rs:41198` | `insert_document_source_page_at_hash` | `pub(crate)` | `insert_page_with_kind_inner` |
| `core/db.rs:41472` | `replace_source_page_inner` | `private` | `append_page_history` |
| `core/db.rs:41753` | `get_page` | `pub` | `get_page_inner` |
| `core/db.rs:41762` | `get_page_browse` | `pub` | `get_page_inner` |
| `core/db.rs:41848` | `list_pages` | `pub` | `list_pages_inner` |
| `core/db.rs:41861` | `list_pages_browse` | `pub` | `list_pages_inner` |
| `core/db.rs:42354` | `try_update_page_content` | `private` | `append_page_history` |
| `core/db.rs:43238` | `accept_page_merge` | `pub` | `page_merge_row` |
| `core/db.rs:43470` | `find_best_overlapping_page` | `pub` | `load_page_source_index` |
| `core/db.rs:43603` | `list_active_page_titles` | `pub` | `list_active_page_titles_scoped` |
| `core/db.rs:44044` | `resolve_orphan_page_links` | `pub` | `find_unique_active_page_id_by_title_scoped` |
| `core/db.rs:46283` | `list_stale_pages` | `pub` | `list_stale_pages_scoped` |
...
| `core/post_write.rs:210` | `rename_page_title_cas` | `pub(crate)` | `rename_page_title_cas_inner` |
| `core/post_write.rs:1601` | `create_page_impl` | `private` | `find_matching_page_scoped` |
| `core/refinery/mod.rs:1570` | `run_redistill_page_slice` | `pub` | `get_stale_page_after` |
| `core/repair.rs:1311` | `prepare_memory_reclassification_with_pages` | `pub` | `prepare_rename_page_title` |
| `core/repair.rs:2038` | `apply_repair_with_pages_inner` | `private` | `apply_deterministic_repair_cas` |
| `core/repair.rs:5976` | `projection_page_row_from_snapshot` | `private` | `projection_page_receipt_sql` |
| `core/repair.rs:5995` | `projection_page_row_from_connection` | `private` | `projection_page_receipt_sql` |
...
| `core/db.rs:21778` | `search_memory_with_cue` | `private` | `augment_with_graph_gated` |
| `core/db.rs:24116` | `augment_with_graph` | `pub` | `augment_with_graph_gated` |
| `core/db.rs:24666` | `augment_with_graph_seeded_scoped` | `private` | `augment_with_graph_gated` |
| `core/db.rs:26181` | `rebind_source_id` | `pub` | `rebind_source_id_inner` |
| `core/db.rs:26194` | `rebind_source_id_with_source_page` | `pub` | `rebind_source_id_inner` |
| `core/db.rs:34301` | `first_active_page` | `pub` | `list_pages` |
| `core/db.rs:41121` | `insert_page` | `pub(crate)` | `insert_page_with_kind` |
| `core/db.rs:41416` | `replace_source_page` | `pub(crate)` | `replace_source_page_inner` |
| `core/db.rs:41441` | `replace_source_page_at_document_hash` | `pub(crate)` | `replace_source_page_inner` |
| `core/db.rs:41815` | `find_page_by_source_memory` | `pub` | `get_page` |
| `core/db.rs:42104` | `update_page_content` | `pub` | `try_update_page_content` |
| `core/db.rs:42137` | `try_update_page_content_if_stale` | `pub` | `try_update_page_content` |
| `core/db.rs:42163` | `try_update_page_content_with_changelog_at_source_revision` | `pub` | `try_update_page_content` |
| `core/db.rs:42211` | `try_update_page_content_with_changelog` | `pub` | `try_update_page_content` |
| `core/db.rs:42245` | `try_update_page_content_with_changelog_at_version` | `pub` | `try_update_page_content` |
| `core/db.rs:42280` | `try_update_page_growth_at_versions` | `pub` | `try_update_page_content` |
| `core/db.rs:42318` | `try_accept_page_revision` | `pub(crate)` | `try_update_page_content` |
| `core/db.rs:42992` | `refresh_page_wikilinks` | `pub` | `get_page` |
| `core/db.rs:43522` | `max_page_overlap` | `pub` | `find_best_overlapping_page` |
...
| `core/post_write.rs:262` | `regenerate_page_projection_cas` | `pub(crate)` | `get_page` |
| `core/post_write.rs:813` | `page_write` | `pub` | `create_page_impl` |
| `core/post_write.rs:937` | `write_document_source_page_impl` | `private` | `insert_document_source_page_at_hash` |
| `core/post_write.rs:1019` | `replace_source_page_impl` | `private` | `get_page` |
| `core/post_write.rs:2373` | `update_page_impl` | `private` | `get_page` |
| `core/post_write.rs:2944` | `accept_page_revision_card` | `private` | `get_page` |
...
| `core/repair.rs:1302` | `prepare_memory_reclassification` | `pub` | `prepare_memory_reclassification_with_pages` |
| `core/repair.rs:2001` | `apply_repair_with_pages` | `pub` | `apply_repair_with_pages_inner` |
| `core/repair.rs:2313` | `apply_rename_page_title` | `private` | `rename_page_title_cas` |
| `core/repair.rs:5697` | `capture_page_projection_rollback` | `pub(crate)` | `projection_page_row_from_snapshot` |
| `core/repair.rs:5837` | `projection_page_row_on_connection` | `pub(crate)` | `projection_page_row_from_connection` |
...
| `server/main.rs:1059` | `run_daemon` | `private` | `list_pages` |
| `server/memory_routes.rs:2184` | `handle_create_page` | `pub` | `get_page` |
| `server/memory_routes.rs:3727` | `handle_update_page` | `pub` | `get_page` |
| `server/memory_routes.rs:3802` | `handle_refresh_page` | `pub` | `get_page` |
