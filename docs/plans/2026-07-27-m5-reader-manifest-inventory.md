...
|---|---|---|---|
| `core/db.rs:3616` | `run_migrations` | `pub` | internal-only |
| `core/db.rs:9108` | `migrate_89_page_kind_fold` | `private` | internal-only |
| `core/db.rs:17048` | `reconcile_entity_page_parity` | `pub` | **exposure** — `server/scheduler.rs:2237` |
| `core/db.rs:26677` | `rebind_source_page_in_transaction` | `private` | internal-only |
| `core/db.rs:34316` | `oldest_active_page` | `pub` | internal-only |
| `core/db.rs:39512` | `list_recent_retrievals` | `pub` | internal-only |
| `core/db.rs:39652` | `list_recent_retrievals_scoped` | `pub` | **exposure** — `server/routes.rs:910` |
| `core/db.rs:39858` | `list_recent_changes` | `pub` | internal-only |
| `core/db.rs:40161` | `list_recent_pages_with_badges` | `pub` | internal-only |
| `core/db.rs:41074` | `append_page_history` | `private` | internal-only |
| `core/db.rs:41235` | `insert_page_with_kind_inner` | `private` | internal-only |
| `core/db.rs:41772` | `get_page_inner` | `private` | internal-only |
| `core/db.rs:41801` | `get_page_by_entity` | `pub` | internal-only |
| `core/db.rs:41876` | `list_pages_inner` | `private` | internal-only |
| `core/db.rs:41909` | `list_pages_stale` | `pub` | internal-only |
| `core/db.rs:41954` | `list_pages_by_space` | `pub` | internal-only |
| `core/db.rs:43015` | `find_matching_page` | `pub` | internal-only |
| `core/db.rs:43072` | `find_matching_page_scoped` | `pub` | internal-only |
| `core/db.rs:43439` | `page_merge_row` | `private` | internal-only |
| `core/db.rs:43488` | `load_page_source_index` | `pub` | **exposure** — `server/routes.rs:655` |
| `core/db.rs:43622` | `list_active_page_titles_scoped` | `pub` | internal-only |
| `core/db.rs:43669` | `list_relevant_active_page_titles` | `pub` | internal-only |
| `core/db.rs:43736` | `find_active_page_id_by_title` | `pub` | internal-only |
| `core/db.rs:43771` | `find_unique_active_page_id_by_title_scoped` | `pub` | internal-only |
| `core/db.rs:44322` | `backfill_page_embeddings` | `pub` | internal-only |
| `core/db.rs:45400` | `get_pages_for_memory` | `pub` | internal-only |
| `core/db.rs:46299` | `get_stale_page_after` | `pub` | internal-only |
| `core/db.rs:46336` | `list_stale_pages_scoped` | `pub` | **exposure** — `server/routes.rs:734` |
| `core/db.rs:46376` | `find_stale_archived_pages` | `pub` | **exposure** — `server/cmd_backfill.rs:49` |
...
| `core/repair.rs:1492` | `prepare_rename_page_title` | `private` | internal-only |
| `core/repair.rs:3764` | `capture_rename_page_row_on_snapshot` | `private` | internal-only |
| `core/repair.rs:3993` | `validate_rename_page_title_collision_on_snapshot` | `private` | internal-only |
| `core/repair.rs:4037` | `validate_rename_page_title_collision_on_connection` | `pub(crate)` | internal-only |
| `core/repair.rs:5979` | `projection_page_receipt_sql` | `private` | internal-only |
...
|---|---|---|---|
| `core/db.rs:3277` | `new` | `pub` | `run_migrations` |
| `core/db.rs:3489` | `new_with_shared_embedder` | `pub` | `run_migrations` |
| `core/db.rs:24139` | `augment_with_graph_gated` | `private` | `search_entities_by_vector_scoped` |
| `core/db.rs:26217` | `rebind_source_id_inner` | `private` | `rebind_source_page_in_transaction` |
| `core/db.rs:41165` | `insert_page_with_kind` | `pub(crate)` | `insert_page_with_kind_inner` |
| `core/db.rs:41204` | `insert_document_source_page_at_hash` | `pub(crate)` | `insert_page_with_kind_inner` |
| `core/db.rs:41478` | `replace_source_page_inner` | `private` | `append_page_history` |
| `core/db.rs:41759` | `get_page` | `pub` | `get_page_inner` |
| `core/db.rs:41768` | `get_page_browse` | `pub` | `get_page_inner` |
| `core/db.rs:41854` | `list_pages` | `pub` | `list_pages_inner` |
| `core/db.rs:41867` | `list_pages_browse` | `pub` | `list_pages_inner` |
| `core/db.rs:42360` | `try_update_page_content` | `private` | `append_page_history` |
| `core/db.rs:43244` | `accept_page_merge` | `pub` | `page_merge_row` |
| `core/db.rs:43476` | `find_best_overlapping_page` | `pub` | `load_page_source_index` |
| `core/db.rs:43609` | `list_active_page_titles` | `pub` | `list_active_page_titles_scoped` |
| `core/db.rs:44050` | `resolve_orphan_page_links` | `pub` | `find_unique_active_page_id_by_title_scoped` |
| `core/db.rs:46289` | `list_stale_pages` | `pub` | `list_stale_pages_scoped` |
...
| `core/repair.rs:1362` | `prepare_memory_reclassification_with_pages` | `pub` | `prepare_rename_page_title` |
| `core/repair.rs:2089` | `apply_repair_with_pages_inner` | `private` | `apply_deterministic_repair_cas` |
| `core/repair.rs:5944` | `projection_page_row_from_snapshot` | `private` | `projection_page_receipt_sql` |
| `core/repair.rs:5963` | `projection_page_row_from_connection` | `private` | `projection_page_receipt_sql` |
...
| `core/db.rs:21784` | `search_memory_with_cue` | `private` | `augment_with_graph_gated` |
| `core/db.rs:24122` | `augment_with_graph` | `pub` | `augment_with_graph_gated` |
| `core/db.rs:24672` | `augment_with_graph_seeded_scoped` | `private` | `augment_with_graph_gated` |
| `core/db.rs:26187` | `rebind_source_id` | `pub` | `rebind_source_id_inner` |
| `core/db.rs:26200` | `rebind_source_id_with_source_page` | `pub` | `rebind_source_id_inner` |
| `core/db.rs:34307` | `first_active_page` | `pub` | `list_pages` |
| `core/db.rs:41127` | `insert_page` | `pub(crate)` | `insert_page_with_kind` |
| `core/db.rs:41422` | `replace_source_page` | `pub(crate)` | `replace_source_page_inner` |
| `core/db.rs:41447` | `replace_source_page_at_document_hash` | `pub(crate)` | `replace_source_page_inner` |
| `core/db.rs:41821` | `find_page_by_source_memory` | `pub` | `get_page` |
| `core/db.rs:42110` | `update_page_content` | `pub` | `try_update_page_content` |
| `core/db.rs:42143` | `try_update_page_content_if_stale` | `pub` | `try_update_page_content` |
| `core/db.rs:42169` | `try_update_page_content_with_changelog_at_source_revision` | `pub` | `try_update_page_content` |
| `core/db.rs:42217` | `try_update_page_content_with_changelog` | `pub` | `try_update_page_content` |
| `core/db.rs:42251` | `try_update_page_content_with_changelog_at_version` | `pub` | `try_update_page_content` |
| `core/db.rs:42286` | `try_update_page_growth_at_versions` | `pub` | `try_update_page_content` |
| `core/db.rs:42324` | `try_accept_page_revision` | `pub(crate)` | `try_update_page_content` |
| `core/db.rs:42998` | `refresh_page_wikilinks` | `pub` | `get_page` |
| `core/db.rs:43528` | `max_page_overlap` | `pub` | `find_best_overlapping_page` |
...
| `core/repair.rs:1353` | `prepare_memory_reclassification` | `pub` | `prepare_memory_reclassification_with_pages` |
| `core/repair.rs:2052` | `apply_repair_with_pages` | `pub` | `apply_repair_with_pages_inner` |
| `core/repair.rs:2364` | `apply_rename_page_title` | `private` | `rename_page_title_cas` |
| `core/repair.rs:5665` | `capture_page_projection_rollback` | `pub(crate)` | `projection_page_row_from_snapshot` |
| `core/repair.rs:5805` | `projection_page_row_on_connection` | `pub(crate)` | `projection_page_row_from_connection` |
