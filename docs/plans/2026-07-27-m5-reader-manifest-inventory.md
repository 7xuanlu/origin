...
|---|---|---|---|
| `core/db.rs:3619` | `run_migrations` | `pub` | internal-only |
| `core/db.rs:9111` | `migrate_89_page_kind_fold` | `private` | internal-only |
| `core/db.rs:17051` | `reconcile_entity_page_parity` | `pub` | **exposure** — `server/scheduler.rs:2237` |
| `core/db.rs:26680` | `rebind_source_page_in_transaction` | `private` | internal-only |
| `core/db.rs:34319` | `oldest_active_page` | `pub` | internal-only |
| `core/db.rs:39515` | `list_recent_retrievals` | `pub` | internal-only |
| `core/db.rs:39655` | `list_recent_retrievals_scoped` | `pub` | **exposure** — `server/routes.rs:910` |
| `core/db.rs:39861` | `list_recent_changes` | `pub` | internal-only |
| `core/db.rs:40164` | `list_recent_pages_with_badges` | `pub` | internal-only |
| `core/db.rs:41077` | `append_page_history` | `private` | internal-only |
| `core/db.rs:41238` | `insert_page_with_kind_inner` | `private` | internal-only |
| `core/db.rs:41775` | `get_page_inner` | `private` | internal-only |
| `core/db.rs:41804` | `get_page_by_entity` | `pub` | internal-only |
| `core/db.rs:41879` | `list_pages_inner` | `private` | internal-only |
| `core/db.rs:41912` | `list_pages_stale` | `pub` | internal-only |
| `core/db.rs:41957` | `list_pages_by_space` | `pub` | internal-only |
| `core/db.rs:43018` | `find_matching_page` | `pub` | internal-only |
| `core/db.rs:43075` | `find_matching_page_scoped` | `pub` | internal-only |
| `core/db.rs:43442` | `page_merge_row` | `private` | internal-only |
| `core/db.rs:43491` | `load_page_source_index` | `pub` | **exposure** — `server/routes.rs:655` |
| `core/db.rs:43625` | `list_active_page_titles_scoped` | `pub` | internal-only |
| `core/db.rs:43672` | `list_relevant_active_page_titles` | `pub` | internal-only |
| `core/db.rs:43739` | `find_active_page_id_by_title` | `pub` | internal-only |
| `core/db.rs:43774` | `find_unique_active_page_id_by_title_scoped` | `pub` | internal-only |
| `core/db.rs:44325` | `backfill_page_embeddings` | `pub` | internal-only |
| `core/db.rs:45403` | `get_pages_for_memory` | `pub` | internal-only |
| `core/db.rs:46302` | `get_stale_page_after` | `pub` | internal-only |
| `core/db.rs:46339` | `list_stale_pages_scoped` | `pub` | **exposure** — `server/routes.rs:734` |
| `core/db.rs:46379` | `find_stale_archived_pages` | `pub` | **exposure** — `server/cmd_backfill.rs:49` |
...
| `core/repair.rs:1493` | `prepare_rename_page_title` | `private` | internal-only |
| `core/repair.rs:3714` | `capture_rename_page_row_on_snapshot` | `private` | internal-only |
| `core/repair.rs:3943` | `validate_rename_page_title_collision_on_snapshot` | `private` | internal-only |
| `core/repair.rs:3987` | `validate_rename_page_title_collision_on_connection` | `pub(crate)` | internal-only |
| `core/repair.rs:5929` | `projection_page_receipt_sql` | `private` | internal-only |
...
|---|---|---|---|
| `core/db.rs:3280` | `new` | `pub` | `run_migrations` |
| `core/db.rs:3492` | `new_with_shared_embedder` | `pub` | `run_migrations` |
| `core/db.rs:24142` | `augment_with_graph_gated` | `private` | `search_entities_by_vector_scoped` |
| `core/db.rs:26220` | `rebind_source_id_inner` | `private` | `rebind_source_page_in_transaction` |
| `core/db.rs:41168` | `insert_page_with_kind` | `pub(crate)` | `insert_page_with_kind_inner` |
| `core/db.rs:41207` | `insert_document_source_page_at_hash` | `pub(crate)` | `insert_page_with_kind_inner` |
| `core/db.rs:41481` | `replace_source_page_inner` | `private` | `append_page_history` |
| `core/db.rs:41762` | `get_page` | `pub` | `get_page_inner` |
| `core/db.rs:41771` | `get_page_browse` | `pub` | `get_page_inner` |
| `core/db.rs:41857` | `list_pages` | `pub` | `list_pages_inner` |
| `core/db.rs:41870` | `list_pages_browse` | `pub` | `list_pages_inner` |
| `core/db.rs:42363` | `try_update_page_content` | `private` | `append_page_history` |
| `core/db.rs:43247` | `accept_page_merge` | `pub` | `page_merge_row` |
| `core/db.rs:43479` | `find_best_overlapping_page` | `pub` | `load_page_source_index` |
| `core/db.rs:43612` | `list_active_page_titles` | `pub` | `list_active_page_titles_scoped` |
| `core/db.rs:44053` | `resolve_orphan_page_links` | `pub` | `find_unique_active_page_id_by_title_scoped` |
| `core/db.rs:46292` | `list_stale_pages` | `pub` | `list_stale_pages_scoped` |
...
| `core/repair.rs:1363` | `prepare_memory_reclassification_with_pages` | `pub` | `prepare_rename_page_title` |
| `core/repair.rs:2090` | `apply_repair_with_pages_inner` | `private` | `apply_deterministic_repair_cas` |
| `core/repair.rs:5894` | `projection_page_row_from_snapshot` | `private` | `projection_page_receipt_sql` |
| `core/repair.rs:5913` | `projection_page_row_from_connection` | `private` | `projection_page_receipt_sql` |
...
| `core/db.rs:21787` | `search_memory_with_cue` | `private` | `augment_with_graph_gated` |
| `core/db.rs:24125` | `augment_with_graph` | `pub` | `augment_with_graph_gated` |
| `core/db.rs:24675` | `augment_with_graph_seeded_scoped` | `private` | `augment_with_graph_gated` |
| `core/db.rs:26190` | `rebind_source_id` | `pub` | `rebind_source_id_inner` |
| `core/db.rs:26203` | `rebind_source_id_with_source_page` | `pub` | `rebind_source_id_inner` |
| `core/db.rs:34310` | `first_active_page` | `pub` | `list_pages` |
| `core/db.rs:41130` | `insert_page` | `pub(crate)` | `insert_page_with_kind` |
| `core/db.rs:41425` | `replace_source_page` | `pub(crate)` | `replace_source_page_inner` |
| `core/db.rs:41450` | `replace_source_page_at_document_hash` | `pub(crate)` | `replace_source_page_inner` |
| `core/db.rs:41824` | `find_page_by_source_memory` | `pub` | `get_page` |
| `core/db.rs:42113` | `update_page_content` | `pub` | `try_update_page_content` |
| `core/db.rs:42146` | `try_update_page_content_if_stale` | `pub` | `try_update_page_content` |
| `core/db.rs:42172` | `try_update_page_content_with_changelog_at_source_revision` | `pub` | `try_update_page_content` |
| `core/db.rs:42220` | `try_update_page_content_with_changelog` | `pub` | `try_update_page_content` |
| `core/db.rs:42254` | `try_update_page_content_with_changelog_at_version` | `pub` | `try_update_page_content` |
| `core/db.rs:42289` | `try_update_page_growth_at_versions` | `pub` | `try_update_page_content` |
| `core/db.rs:42327` | `try_accept_page_revision` | `pub(crate)` | `try_update_page_content` |
| `core/db.rs:43001` | `refresh_page_wikilinks` | `pub` | `get_page` |
| `core/db.rs:43531` | `max_page_overlap` | `pub` | `find_best_overlapping_page` |
...
| `core/repair.rs:1354` | `prepare_memory_reclassification` | `pub` | `prepare_memory_reclassification_with_pages` |
| `core/repair.rs:2053` | `apply_repair_with_pages` | `pub` | `apply_repair_with_pages_inner` |
| `core/repair.rs:2365` | `apply_rename_page_title` | `private` | `rename_page_title_cas` |
| `core/repair.rs:5615` | `capture_page_projection_rollback` | `pub(crate)` | `projection_page_row_from_snapshot` |
| `core/repair.rs:5755` | `projection_page_row_on_connection` | `pub(crate)` | `projection_page_row_from_connection` |
