...
| `core/repair.rs:3980` | `capture_rename_page_row_on_snapshot` | `private` | internal-only |
| `core/repair.rs:4209` | `validate_rename_page_title_collision_on_snapshot` | `private` | internal-only |
| `core/repair.rs:4253` | `validate_rename_page_title_collision_on_connection` | `pub(crate)` | internal-only |
| `core/repair.rs:6195` | `projection_page_receipt_sql` | `private` | internal-only |
...
| `core/repair.rs:6160` | `projection_page_row_from_snapshot` | `private` | `projection_page_receipt_sql` |
| `core/repair.rs:6179` | `projection_page_row_from_connection` | `private` | `projection_page_receipt_sql` |
...
| `core/repair.rs:5881` | `capture_page_projection_rollback` | `pub(crate)` | `projection_page_row_from_snapshot` |
| `core/repair.rs:6021` | `projection_page_row_on_connection` | `pub(crate)` | `projection_page_row_from_connection` |
