...
| `core/db.rs:9147` | `migrate_89_page_kind_fold` | `private` | internal-only |
| `core/db.rs:17170` | `reconcile_entity_page_parity` | `pub` | **exposure** — `server/scheduler/ambient.rs:532` |
| `core/db.rs:26799` | `rebind_source_page_in_transaction` | `private` | internal-only |
| `core/db.rs:34438` | `oldest_active_page` | `pub` | internal-only |
| `core/db.rs:39634` | `list_recent_retrievals` | `pub` | internal-only |
| `core/db.rs:39774` | `list_recent_retrievals_scoped` | `pub` | **exposure** — `server/routes.rs:948` |
| `core/db.rs:39980` | `list_recent_changes` | `pub` | internal-only |
| `core/db.rs:40283` | `list_recent_pages_with_badges` | `pub` | internal-only |
| `core/db.rs:41196` | `append_page_history` | `private` | internal-only |
| `core/db.rs:41357` | `insert_page_with_kind_inner` | `private` | internal-only |
| `core/db.rs:41894` | `get_page_inner` | `private` | internal-only |
| `core/db.rs:41923` | `get_page_by_entity` | `pub` | internal-only |
| `core/db.rs:41998` | `list_pages_inner` | `private` | internal-only |
| `core/db.rs:42031` | `list_pages_stale` | `pub` | internal-only |
| `core/db.rs:42076` | `list_pages_by_space` | `pub` | internal-only |
| `core/db.rs:43137` | `find_matching_page` | `pub` | internal-only |
| `core/db.rs:43194` | `find_matching_page_scoped` | `pub` | internal-only |
| `core/db.rs:43561` | `page_merge_row` | `private` | internal-only |
| `core/db.rs:43610` | `load_page_source_index` | `pub` | **exposure** — `server/routes.rs:693` |
| `core/db.rs:43744` | `list_active_page_titles_scoped` | `pub` | internal-only |
| `core/db.rs:43791` | `list_relevant_active_page_titles` | `pub` | internal-only |
| `core/db.rs:43858` | `find_active_page_id_by_title` | `pub` | internal-only |
| `core/db.rs:43893` | `find_unique_active_page_id_by_title_scoped` | `pub` | internal-only |
| `core/db.rs:44444` | `backfill_page_embeddings` | `pub` | internal-only |
| `core/db.rs:45522` | `get_pages_for_memory` | `pub` | internal-only |
| `core/db.rs:46421` | `get_stale_page_after` | `pub` | internal-only |
| `core/db.rs:46458` | `list_stale_pages_scoped` | `pub` | **exposure** — `server/routes.rs:772` |
| `core/db.rs:46498` | `find_stale_archived_pages` | `pub` | **exposure** — `server/cmd_backfill.rs:49` |
| `core/db/claim_derivation.rs:948` | `evaluate_support_on` | `private` | internal-only |
...
| `core/db/truth_exposure.rs:370` | `page_truth_states` | `pub` | internal-only |
...
| `core/db.rs:24261` | `augment_with_graph_gated` | `private` | `search_entities_by_vector_scoped` |
| `core/db.rs:26339` | `rebind_source_id_inner` | `private` | `rebind_source_page_in_transaction` |
| `core/db.rs:41287` | `insert_page_with_kind` | `pub(crate)` | `insert_page_with_kind_inner` |
| `core/db.rs:41326` | `insert_document_source_page_at_hash` | `pub(crate)` | `insert_page_with_kind_inner` |
| `core/db.rs:41600` | `replace_source_page_inner` | `private` | `append_page_history` |
| `core/db.rs:41881` | `get_page` | `pub` | `get_page_inner` |
| `core/db.rs:41890` | `get_page_browse` | `pub` | `get_page_inner` |
| `core/db.rs:41976` | `list_pages` | `pub` | `list_pages_inner` |
| `core/db.rs:41989` | `list_pages_browse` | `pub` | `list_pages_inner` |
| `core/db.rs:42482` | `try_update_page_content` | `private` | `append_page_history` |
| `core/db.rs:43366` | `accept_page_merge` | `pub` | `page_merge_row` |
| `core/db.rs:43598` | `find_best_overlapping_page` | `pub` | `load_page_source_index` |
| `core/db.rs:43731` | `list_active_page_titles` | `pub` | `list_active_page_titles_scoped` |
| `core/db.rs:44172` | `resolve_orphan_page_links` | `pub` | `find_unique_active_page_id_by_title_scoped` |
| `core/db.rs:46411` | `list_stale_pages` | `pub` | `list_stale_pages_scoped` |
| `core/db/claim_derivation.rs:760` | `evaluate_page_support` | `pub` | `evaluate_support_on` |
| `core/db/claim_derivation.rs:1299` | `finalize_page_support` | `pub` | `evaluate_support_on` |
...
| `core/db/truth_exposure.rs:507` | `page_visibility` | `pub` | `page_truth_states` |
...
| `core/db.rs:21906` | `search_memory_with_cue` | `private` | `augment_with_graph_gated` |
| `core/db.rs:24244` | `augment_with_graph` | `pub` | `augment_with_graph_gated` |
| `core/db.rs:24794` | `augment_with_graph_seeded_scoped` | `private` | `augment_with_graph_gated` |
| `core/db.rs:26309` | `rebind_source_id` | `pub` | `rebind_source_id_inner` |
| `core/db.rs:26322` | `rebind_source_id_with_source_page` | `pub` | `rebind_source_id_inner` |
| `core/db.rs:34429` | `first_active_page` | `pub` | `list_pages` |
| `core/db.rs:41249` | `insert_page` | `pub(crate)` | `insert_page_with_kind` |
| `core/db.rs:41544` | `replace_source_page` | `pub(crate)` | `replace_source_page_inner` |
| `core/db.rs:41569` | `replace_source_page_at_document_hash` | `pub(crate)` | `replace_source_page_inner` |
| `core/db.rs:41943` | `find_page_by_source_memory` | `pub` | `get_page` |
| `core/db.rs:42232` | `update_page_content` | `pub` | `try_update_page_content` |
| `core/db.rs:42265` | `try_update_page_content_if_stale` | `pub` | `try_update_page_content` |
| `core/db.rs:42291` | `try_update_page_content_with_changelog_at_source_revision` | `pub` | `try_update_page_content` |
| `core/db.rs:42339` | `try_update_page_content_with_changelog` | `pub` | `try_update_page_content` |
| `core/db.rs:42373` | `try_update_page_content_with_changelog_at_version` | `pub` | `try_update_page_content` |
| `core/db.rs:42408` | `try_update_page_growth_at_versions` | `pub` | `try_update_page_content` |
| `core/db.rs:42446` | `try_accept_page_revision` | `pub(crate)` | `try_update_page_content` |
| `core/db.rs:43120` | `refresh_page_wikilinks` | `pub` | `get_page` |
| `core/db.rs:43650` | `max_page_overlap` | `pub` | `find_best_overlapping_page` |
...
| `core/db.rs:21869` | `search_memory` | `pub` | `search_memory_with_cue` |
| `core/db.rs:22682` | `search_memory_temporal` | `pub` | `search_memory_with_cue` |
| `core/db.rs:23193` | `search_memory_cross_rerank_cued` | `pub` | `search_memory_with_cue` |
| `core/db.rs:23662` | `search_memory_expanded` | `pub` | `search_memory_with_cue` |
| `core/db.rs:24777` | `augment_with_graph_seeded` | `pub` | `augment_with_graph_seeded_scoped` |
