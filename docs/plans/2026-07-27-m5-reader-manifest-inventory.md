...
| `core/db.rs:26920` | `rebind_source_page_in_transaction` | `private` | internal-only |
| `core/db.rs:34559` | `oldest_active_page` | `pub` | internal-only |
| `core/db.rs:39755` | `list_recent_retrievals` | `pub` | internal-only |
| `core/db.rs:39895` | `list_recent_retrievals_scoped` | `pub` | **exposure** — `server/routes.rs:948` |
| `core/db.rs:40101` | `list_recent_changes` | `pub` | internal-only |
| `core/db.rs:40404` | `list_recent_pages_with_badges` | `pub` | internal-only |
| `core/db.rs:41317` | `append_page_history` | `private` | internal-only |
| `core/db.rs:41478` | `insert_page_with_kind_inner` | `private` | internal-only |
| `core/db.rs:42015` | `get_page_inner` | `private` | internal-only |
| `core/db.rs:42044` | `get_page_by_entity` | `pub` | internal-only |
| `core/db.rs:42119` | `list_pages_inner` | `private` | internal-only |
| `core/db.rs:42152` | `list_pages_stale` | `pub` | internal-only |
| `core/db.rs:42197` | `list_pages_by_space` | `pub` | internal-only |
| `core/db.rs:43258` | `find_matching_page` | `pub` | internal-only |
| `core/db.rs:43315` | `find_matching_page_scoped` | `pub` | internal-only |
| `core/db.rs:43682` | `page_merge_row` | `private` | internal-only |
| `core/db.rs:43731` | `load_page_source_index` | `pub` | **exposure** — `server/routes.rs:693` |
| `core/db.rs:43865` | `list_active_page_titles_scoped` | `pub` | internal-only |
| `core/db.rs:43912` | `list_relevant_active_page_titles` | `pub` | internal-only |
| `core/db.rs:43979` | `find_active_page_id_by_title` | `pub` | internal-only |
| `core/db.rs:44014` | `find_unique_active_page_id_by_title_scoped` | `pub` | internal-only |
| `core/db.rs:44565` | `backfill_page_embeddings` | `pub` | internal-only |
| `core/db.rs:45643` | `get_pages_for_memory` | `pub` | internal-only |
| `core/db.rs:46542` | `get_stale_page_after` | `pub` | internal-only |
| `core/db.rs:46579` | `list_stale_pages_scoped` | `pub` | **exposure** — `server/routes.rs:772` |
| `core/db.rs:46619` | `find_stale_archived_pages` | `pub` | **exposure** — `server/cmd_backfill.rs:49` |
| `core/db/claim_derivation.rs:1284` | `evaluate_support_on` | `private` | internal-only |
...
| `core/db.rs:41408` | `insert_page_with_kind` | `pub(crate)` | `insert_page_with_kind_inner` |
| `core/db.rs:41447` | `insert_document_source_page_at_hash` | `pub(crate)` | `insert_page_with_kind_inner` |
| `core/db.rs:41721` | `replace_source_page_inner` | `private` | `append_page_history` |
| `core/db.rs:42002` | `get_page` | `pub` | `get_page_inner` |
| `core/db.rs:42011` | `get_page_browse` | `pub` | `get_page_inner` |
| `core/db.rs:42097` | `list_pages` | `pub` | `list_pages_inner` |
| `core/db.rs:42110` | `list_pages_browse` | `pub` | `list_pages_inner` |
| `core/db.rs:42603` | `try_update_page_content` | `private` | `append_page_history` |
| `core/db.rs:43487` | `accept_page_merge` | `pub` | `page_merge_row` |
| `core/db.rs:43719` | `find_best_overlapping_page` | `pub` | `load_page_source_index` |
| `core/db.rs:43852` | `list_active_page_titles` | `pub` | `list_active_page_titles_scoped` |
| `core/db.rs:44293` | `resolve_orphan_page_links` | `pub` | `find_unique_active_page_id_by_title_scoped` |
| `core/db.rs:46532` | `list_stale_pages` | `pub` | `list_stale_pages_scoped` |
| `core/db/claim_derivation.rs:725` | `reconcile_supported_pages` | `pub` | `evaluate_support_on` |
| `core/db/claim_derivation.rs:1096` | `evaluate_page_support` | `pub` | `evaluate_support_on` |
| `core/db/claim_derivation.rs:1746` | `finalize_page_support` | `pub` | `evaluate_support_on` |
...
| `core/db/truth_exposure.rs:528` | `page_visibility` | `pub` | `page_truth_states` |
...
| `core/db.rs:34550` | `first_active_page` | `pub` | `list_pages` |
| `core/db.rs:41370` | `insert_page` | `pub(crate)` | `insert_page_with_kind` |
| `core/db.rs:41665` | `replace_source_page` | `pub(crate)` | `replace_source_page_inner` |
| `core/db.rs:41690` | `replace_source_page_at_document_hash` | `pub(crate)` | `replace_source_page_inner` |
| `core/db.rs:42064` | `find_page_by_source_memory` | `pub` | `get_page` |
| `core/db.rs:42353` | `update_page_content` | `pub` | `try_update_page_content` |
| `core/db.rs:42386` | `try_update_page_content_if_stale` | `pub` | `try_update_page_content` |
| `core/db.rs:42412` | `try_update_page_content_with_changelog_at_source_revision` | `pub` | `try_update_page_content` |
| `core/db.rs:42460` | `try_update_page_content_with_changelog` | `pub` | `try_update_page_content` |
| `core/db.rs:42494` | `try_update_page_content_with_changelog_at_version` | `pub` | `try_update_page_content` |
| `core/db.rs:42529` | `try_update_page_growth_at_versions` | `pub` | `try_update_page_content` |
| `core/db.rs:42567` | `try_accept_page_revision` | `pub(crate)` | `try_update_page_content` |
| `core/db.rs:43241` | `refresh_page_wikilinks` | `pub` | `get_page` |
| `core/db.rs:43771` | `max_page_overlap` | `pub` | `find_best_overlapping_page` |
...
| `server/main/startup.rs:14` | `prepare_startup_state` | `pub(super)` | `list_pages` |
