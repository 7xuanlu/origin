...
|---|---|---|---|
| `core/db.rs:3601` | `run_migrations` | `pub` | internal-only |
| `core/db.rs:9093` | `migrate_89_page_kind_fold` | `private` | internal-only |
| `core/db.rs:17033` | `reconcile_entity_page_parity` | `pub` | **exposure** — `server/scheduler.rs:2237` |
| `core/db.rs:26662` | `rebind_source_page_in_transaction` | `private` | internal-only |
| `core/db.rs:34301` | `oldest_active_page` | `pub` | internal-only |
| `core/db.rs:39497` | `list_recent_retrievals` | `pub` | internal-only |
| `core/db.rs:39637` | `list_recent_retrievals_scoped` | `pub` | **exposure** — `server/routes.rs:910` |
| `core/db.rs:39843` | `list_recent_changes` | `pub` | internal-only |
| `core/db.rs:40146` | `list_recent_pages_with_badges` | `pub` | internal-only |
| `core/db.rs:41059` | `append_page_history` | `private` | internal-only |
| `core/db.rs:41220` | `insert_page_with_kind_inner` | `private` | internal-only |
| `core/db.rs:41757` | `get_page_inner` | `private` | internal-only |
| `core/db.rs:41786` | `get_page_by_entity` | `pub` | internal-only |
| `core/db.rs:41861` | `list_pages_inner` | `private` | internal-only |
| `core/db.rs:41894` | `list_pages_stale` | `pub` | internal-only |
| `core/db.rs:41939` | `list_pages_by_space` | `pub` | internal-only |
| `core/db.rs:43000` | `find_matching_page` | `pub` | internal-only |
| `core/db.rs:43057` | `find_matching_page_scoped` | `pub` | internal-only |
| `core/db.rs:43424` | `page_merge_row` | `private` | internal-only |
| `core/db.rs:43473` | `load_page_source_index` | `pub` | **exposure** — `server/routes.rs:655` |
| `core/db.rs:43607` | `list_active_page_titles_scoped` | `pub` | internal-only |
| `core/db.rs:43654` | `list_relevant_active_page_titles` | `pub` | internal-only |
| `core/db.rs:43721` | `find_active_page_id_by_title` | `pub` | internal-only |
| `core/db.rs:43756` | `find_unique_active_page_id_by_title_scoped` | `pub` | internal-only |
| `core/db.rs:44307` | `backfill_page_embeddings` | `pub` | internal-only |
| `core/db.rs:45385` | `get_pages_for_memory` | `pub` | internal-only |
| `core/db.rs:46284` | `get_stale_page_after` | `pub` | internal-only |
| `core/db.rs:46321` | `list_stale_pages_scoped` | `pub` | **exposure** — `server/routes.rs:734` |
| `core/db.rs:46361` | `find_stale_archived_pages` | `pub` | **exposure** — `server/cmd_backfill.rs:49` |
...
|---|---|---|---|
| `core/db.rs:3262` | `new` | `pub` | `run_migrations` |
| `core/db.rs:3474` | `new_with_shared_embedder` | `pub` | `run_migrations` |
| `core/db.rs:24124` | `augment_with_graph_gated` | `private` | `search_entities_by_vector_scoped` |
| `core/db.rs:26202` | `rebind_source_id_inner` | `private` | `rebind_source_page_in_transaction` |
| `core/db.rs:41150` | `insert_page_with_kind` | `pub(crate)` | `insert_page_with_kind_inner` |
| `core/db.rs:41189` | `insert_document_source_page_at_hash` | `pub(crate)` | `insert_page_with_kind_inner` |
| `core/db.rs:41463` | `replace_source_page_inner` | `private` | `append_page_history` |
| `core/db.rs:41744` | `get_page` | `pub` | `get_page_inner` |
| `core/db.rs:41753` | `get_page_browse` | `pub` | `get_page_inner` |
| `core/db.rs:41839` | `list_pages` | `pub` | `list_pages_inner` |
| `core/db.rs:41852` | `list_pages_browse` | `pub` | `list_pages_inner` |
| `core/db.rs:42345` | `try_update_page_content` | `private` | `append_page_history` |
| `core/db.rs:43229` | `accept_page_merge` | `pub` | `page_merge_row` |
| `core/db.rs:43461` | `find_best_overlapping_page` | `pub` | `load_page_source_index` |
| `core/db.rs:43594` | `list_active_page_titles` | `pub` | `list_active_page_titles_scoped` |
| `core/db.rs:44035` | `resolve_orphan_page_links` | `pub` | `find_unique_active_page_id_by_title_scoped` |
| `core/db.rs:46274` | `list_stale_pages` | `pub` | `list_stale_pages_scoped` |
...
| `core/post_write.rs:2680` | `create_page_impl` | `private` | `find_matching_page_scoped` |
...
| `core/db.rs:21769` | `search_memory_with_cue` | `private` | `augment_with_graph_gated` |
| `core/db.rs:24107` | `augment_with_graph` | `pub` | `augment_with_graph_gated` |
| `core/db.rs:24657` | `augment_with_graph_seeded_scoped` | `private` | `augment_with_graph_gated` |
| `core/db.rs:26172` | `rebind_source_id` | `pub` | `rebind_source_id_inner` |
| `core/db.rs:26185` | `rebind_source_id_with_source_page` | `pub` | `rebind_source_id_inner` |
| `core/db.rs:34292` | `first_active_page` | `pub` | `list_pages` |
| `core/db.rs:41112` | `insert_page` | `pub(crate)` | `insert_page_with_kind` |
| `core/db.rs:41407` | `replace_source_page` | `pub(crate)` | `replace_source_page_inner` |
| `core/db.rs:41432` | `replace_source_page_at_document_hash` | `pub(crate)` | `replace_source_page_inner` |
| `core/db.rs:41806` | `find_page_by_source_memory` | `pub` | `get_page` |
| `core/db.rs:42095` | `update_page_content` | `pub` | `try_update_page_content` |
| `core/db.rs:42128` | `try_update_page_content_if_stale` | `pub` | `try_update_page_content` |
| `core/db.rs:42154` | `try_update_page_content_with_changelog_at_source_revision` | `pub` | `try_update_page_content` |
| `core/db.rs:42202` | `try_update_page_content_with_changelog` | `pub` | `try_update_page_content` |
| `core/db.rs:42236` | `try_update_page_content_with_changelog_at_version` | `pub` | `try_update_page_content` |
| `core/db.rs:42271` | `try_update_page_growth_at_versions` | `pub` | `try_update_page_content` |
| `core/db.rs:42309` | `try_accept_page_revision` | `pub(crate)` | `try_update_page_content` |
| `core/db.rs:42983` | `refresh_page_wikilinks` | `pub` | `get_page` |
| `core/db.rs:43513` | `max_page_overlap` | `pub` | `find_best_overlapping_page` |
...
| `core/post_write.rs:1892` | `page_write` | `pub` | `create_page_impl` |
| `core/post_write.rs:2016` | `write_document_source_page_impl` | `private` | `insert_document_source_page_at_hash` |
| `core/post_write.rs:2098` | `replace_source_page_impl` | `private` | `get_page` |
| `core/post_write.rs:3452` | `update_page_impl` | `private` | `get_page` |
| `core/post_write.rs:4023` | `accept_page_revision_card` | `private` | `get_page` |
