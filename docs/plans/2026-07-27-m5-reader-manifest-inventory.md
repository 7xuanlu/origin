...
| `core/db.rs:26948` | `rebind_source_page_in_transaction` | `private` | internal-only |
| `core/db.rs:34587` | `oldest_active_page` | `pub` | internal-only |
| `core/db.rs:39783` | `list_recent_retrievals` | `pub` | internal-only |
| `core/db.rs:39923` | `list_recent_retrievals_scoped` | `pub` | **exposure** — `server/routes.rs:948` |
| `core/db.rs:40129` | `list_recent_changes` | `pub` | internal-only |
| `core/db.rs:40432` | `list_recent_pages_with_badges` | `pub` | internal-only |
| `core/db.rs:41345` | `append_page_history` | `private` | internal-only |
| `core/db.rs:41506` | `insert_page_with_kind_inner` | `private` | internal-only |
| `core/db.rs:42043` | `get_page_inner` | `private` | internal-only |
| `core/db.rs:42072` | `get_page_by_entity` | `pub` | internal-only |
| `core/db.rs:42147` | `list_pages_inner` | `private` | internal-only |
| `core/db.rs:42180` | `list_pages_stale` | `pub` | internal-only |
| `core/db.rs:42225` | `list_pages_by_space` | `pub` | internal-only |
| `core/db.rs:43286` | `find_matching_page` | `pub` | internal-only |
| `core/db.rs:43343` | `find_matching_page_scoped` | `pub` | internal-only |
| `core/db.rs:43710` | `page_merge_row` | `private` | internal-only |
| `core/db.rs:43759` | `load_page_source_index` | `pub` | **exposure** — `server/routes.rs:693` |
| `core/db.rs:43893` | `list_active_page_titles_scoped` | `pub` | internal-only |
| `core/db.rs:43940` | `list_relevant_active_page_titles` | `pub` | internal-only |
| `core/db.rs:44007` | `find_active_page_id_by_title` | `pub` | internal-only |
| `core/db.rs:44042` | `find_unique_active_page_id_by_title_scoped` | `pub` | internal-only |
| `core/db.rs:44593` | `backfill_page_embeddings` | `pub` | internal-only |
| `core/db.rs:45671` | `get_pages_for_memory` | `pub` | internal-only |
| `core/db.rs:46570` | `get_stale_page_after` | `pub` | internal-only |
| `core/db.rs:46607` | `list_stale_pages_scoped` | `pub` | **exposure** — `server/routes.rs:772` |
| `core/db.rs:46647` | `find_stale_archived_pages` | `pub` | **exposure** — `server/cmd_backfill.rs:49` |
| `core/db/claim_derivation.rs:1710` | `evaluate_support_on` | `private` | internal-only |
...
| `core/db.rs:41436` | `insert_page_with_kind` | `pub(crate)` | `insert_page_with_kind_inner` |
| `core/db.rs:41475` | `insert_document_source_page_at_hash` | `pub(crate)` | `insert_page_with_kind_inner` |
| `core/db.rs:41749` | `replace_source_page_inner` | `private` | `append_page_history` |
| `core/db.rs:42030` | `get_page` | `pub` | `get_page_inner` |
| `core/db.rs:42039` | `get_page_browse` | `pub` | `get_page_inner` |
| `core/db.rs:42125` | `list_pages` | `pub` | `list_pages_inner` |
| `core/db.rs:42138` | `list_pages_browse` | `pub` | `list_pages_inner` |
| `core/db.rs:42631` | `try_update_page_content` | `private` | `append_page_history` |
| `core/db.rs:43515` | `accept_page_merge` | `pub` | `page_merge_row` |
| `core/db.rs:43747` | `find_best_overlapping_page` | `pub` | `load_page_source_index` |
| `core/db.rs:43880` | `list_active_page_titles` | `pub` | `list_active_page_titles_scoped` |
| `core/db.rs:44321` | `resolve_orphan_page_links` | `pub` | `find_unique_active_page_id_by_title_scoped` |
| `core/db.rs:46560` | `list_stale_pages` | `pub` | `list_stale_pages_scoped` |
| `core/db/claim_derivation.rs:913` | `reconcile_supported_pages` | `pub` | `evaluate_support_on` |
| `core/db/claim_derivation.rs:1457` | `evaluate_page_support` | `pub` | `evaluate_support_on` |
| `core/db/claim_derivation.rs:2343` | `finalize_page_support` | `pub` | `evaluate_support_on` |
...
| `core/db.rs:34578` | `first_active_page` | `pub` | `list_pages` |
| `core/db.rs:41398` | `insert_page` | `pub(crate)` | `insert_page_with_kind` |
| `core/db.rs:41693` | `replace_source_page` | `pub(crate)` | `replace_source_page_inner` |
| `core/db.rs:41718` | `replace_source_page_at_document_hash` | `pub(crate)` | `replace_source_page_inner` |
| `core/db.rs:42092` | `find_page_by_source_memory` | `pub` | `get_page` |
| `core/db.rs:42381` | `update_page_content` | `pub` | `try_update_page_content` |
| `core/db.rs:42414` | `try_update_page_content_if_stale` | `pub` | `try_update_page_content` |
| `core/db.rs:42440` | `try_update_page_content_with_changelog_at_source_revision` | `pub` | `try_update_page_content` |
| `core/db.rs:42488` | `try_update_page_content_with_changelog` | `pub` | `try_update_page_content` |
| `core/db.rs:42522` | `try_update_page_content_with_changelog_at_version` | `pub` | `try_update_page_content` |
| `core/db.rs:42557` | `try_update_page_growth_at_versions` | `pub` | `try_update_page_content` |
| `core/db.rs:42595` | `try_accept_page_revision` | `pub(crate)` | `try_update_page_content` |
| `core/db.rs:43269` | `refresh_page_wikilinks` | `pub` | `get_page` |
| `core/db.rs:43799` | `max_page_overlap` | `pub` | `find_best_overlapping_page` |
