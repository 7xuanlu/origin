...
| `core/db.rs:17364` | `reconcile_entity_page_parity` | `pub` | **exposure** — `server/scheduler/ambient.rs:532` |
| `core/db.rs:27031` | `rebind_source_page_in_transaction` | `private` | internal-only |
| `core/db.rs:34670` | `oldest_active_page` | `pub` | internal-only |
| `core/db.rs:39866` | `list_recent_retrievals` | `pub` | internal-only |
| `core/db.rs:40006` | `list_recent_retrievals_scoped` | `pub` | **exposure** — `server/routes.rs:948` |
| `core/db.rs:40212` | `list_recent_changes` | `pub` | internal-only |
| `core/db.rs:40515` | `list_recent_pages_with_badges` | `pub` | internal-only |
| `core/db.rs:41428` | `append_page_history` | `private` | internal-only |
| `core/db.rs:41589` | `insert_page_with_kind_inner` | `private` | internal-only |
| `core/db.rs:42132` | `get_page_inner` | `private` | internal-only |
| `core/db.rs:42161` | `get_page_by_entity` | `pub` | internal-only |
| `core/db.rs:42236` | `list_pages_inner` | `private` | internal-only |
| `core/db.rs:42269` | `list_pages_stale` | `pub` | internal-only |
| `core/db.rs:42314` | `list_pages_by_space` | `pub` | internal-only |
| `core/db.rs:43375` | `find_matching_page` | `pub` | internal-only |
| `core/db.rs:43432` | `find_matching_page_scoped` | `pub` | internal-only |
| `core/db.rs:43799` | `page_merge_row` | `private` | internal-only |
| `core/db.rs:43848` | `load_page_source_index` | `pub` | **exposure** — `server/routes.rs:693` |
| `core/db.rs:43982` | `list_active_page_titles_scoped` | `pub` | internal-only |
| `core/db.rs:44029` | `list_relevant_active_page_titles` | `pub` | internal-only |
| `core/db.rs:44096` | `find_active_page_id_by_title` | `pub` | internal-only |
| `core/db.rs:44131` | `find_unique_active_page_id_by_title_scoped` | `pub` | internal-only |
| `core/db.rs:44682` | `backfill_page_embeddings` | `pub` | internal-only |
| `core/db.rs:45760` | `get_pages_for_memory` | `pub` | internal-only |
| `core/db.rs:46659` | `get_stale_page_after` | `pub` | internal-only |
| `core/db.rs:46696` | `list_stale_pages_scoped` | `pub` | **exposure** — `server/routes.rs:772` |
| `core/db.rs:46736` | `find_stale_archived_pages` | `pub` | **exposure** — `server/cmd_backfill.rs:49` |
...
| `core/db.rs:24455` | `augment_with_graph_gated` | `private` | `search_entities_by_vector_scoped` |
| `core/db.rs:26533` | `rebind_source_id_inner` | `private` | `rebind_source_page_in_transaction` |
| `core/db.rs:41519` | `insert_page_with_kind` | `pub(crate)` | `insert_page_with_kind_inner` |
| `core/db.rs:41558` | `insert_document_source_page_at_hash` | `pub(crate)` | `insert_page_with_kind_inner` |
| `core/db.rs:41838` | `replace_source_page_inner` | `private` | `append_page_history` |
| `core/db.rs:42119` | `get_page` | `pub` | `get_page_inner` |
| `core/db.rs:42128` | `get_page_browse` | `pub` | `get_page_inner` |
| `core/db.rs:42214` | `list_pages` | `pub` | `list_pages_inner` |
| `core/db.rs:42227` | `list_pages_browse` | `pub` | `list_pages_inner` |
| `core/db.rs:42720` | `try_update_page_content` | `private` | `append_page_history` |
| `core/db.rs:43604` | `accept_page_merge` | `pub` | `page_merge_row` |
| `core/db.rs:43836` | `find_best_overlapping_page` | `pub` | `load_page_source_index` |
| `core/db.rs:43969` | `list_active_page_titles` | `pub` | `list_active_page_titles_scoped` |
| `core/db.rs:44410` | `resolve_orphan_page_links` | `pub` | `find_unique_active_page_id_by_title_scoped` |
| `core/db.rs:46649` | `list_stale_pages` | `pub` | `list_stale_pages_scoped` |
...
| `core/db.rs:22100` | `search_memory_with_cue` | `private` | `augment_with_graph_gated` |
| `core/db.rs:24438` | `augment_with_graph` | `pub` | `augment_with_graph_gated` |
| `core/db.rs:24988` | `augment_with_graph_seeded_scoped` | `private` | `augment_with_graph_gated` |
| `core/db.rs:26503` | `rebind_source_id` | `pub` | `rebind_source_id_inner` |
| `core/db.rs:26516` | `rebind_source_id_with_source_page` | `pub` | `rebind_source_id_inner` |
| `core/db.rs:34661` | `first_active_page` | `pub` | `list_pages` |
| `core/db.rs:41481` | `insert_page` | `pub(crate)` | `insert_page_with_kind` |
| `core/db.rs:41782` | `replace_source_page` | `pub(crate)` | `replace_source_page_inner` |
| `core/db.rs:41807` | `replace_source_page_at_document_hash` | `pub(crate)` | `replace_source_page_inner` |
| `core/db.rs:42181` | `find_page_by_source_memory` | `pub` | `get_page` |
| `core/db.rs:42470` | `update_page_content` | `pub` | `try_update_page_content` |
| `core/db.rs:42503` | `try_update_page_content_if_stale` | `pub` | `try_update_page_content` |
| `core/db.rs:42529` | `try_update_page_content_with_changelog_at_source_revision` | `pub` | `try_update_page_content` |
| `core/db.rs:42577` | `try_update_page_content_with_changelog` | `pub` | `try_update_page_content` |
| `core/db.rs:42611` | `try_update_page_content_with_changelog_at_version` | `pub` | `try_update_page_content` |
| `core/db.rs:42646` | `try_update_page_growth_at_versions` | `pub` | `try_update_page_content` |
| `core/db.rs:42684` | `try_accept_page_revision` | `pub(crate)` | `try_update_page_content` |
| `core/db.rs:43358` | `refresh_page_wikilinks` | `pub` | `get_page` |
| `core/db.rs:43888` | `max_page_overlap` | `pub` | `find_best_overlapping_page` |
...
| `core/db.rs:22063` | `search_memory` | `pub` | `search_memory_with_cue` |
| `core/db.rs:22876` | `search_memory_temporal` | `pub` | `search_memory_with_cue` |
| `core/db.rs:23387` | `search_memory_cross_rerank_cued` | `pub` | `search_memory_with_cue` |
| `core/db.rs:23856` | `search_memory_expanded` | `pub` | `search_memory_with_cue` |
| `core/db.rs:24971` | `augment_with_graph_seeded` | `pub` | `augment_with_graph_seeded_scoped` |
