...
///
/// 79 page-bearing, 86 not. Expands to 169 `(builder, method, path)`
/// runtime entries: 163 in `main`, 6 in `repair`.
#[rustfmt::skip]
pub const HTTP_READERS: &[HttpReader] = &[
    HttpReader { method: ReaderMethod::Get, path: "/api/activities", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_list_activities", evidence: "AgentActivityRow.memory_titles" },
    HttpReader { method: ReaderMethod::Get, path: "/api/agents", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_list_agents", evidence: "AgentResponse.description" },
    ...
    HttpReader { method: ReaderMethod::Get, path: "/api/agents/{name}", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_get_agent", evidence: "AgentResponse.description" },
    HttpReader { method: ReaderMethod::Put, path: "/api/agents/{name}", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_update_agent", evidence: "AgentResponse.description" },
    HttpReader { method: ReaderMethod::Get, path: "/api/briefing", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_get_briefing", evidence: "BriefingResponse.content" },
    ...
    HttpReader { method: ReaderMethod::Get, path: "/api/chunks/{source_id}", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_get_chunks", evidence: "MemoryDetail.content, MemoryDetail.summary, MemoryDetail.title" },
    ...
    HttpReader { method: ReaderMethod::Get, path: "/api/config", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_get_config", evidence: "ConfigResponse.skip_title_patterns" },
    HttpReader { method: ReaderMethod::Put, path: "/api/config", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_update_config", evidence: "ConfigResponse.skip_title_patterns" },
    ...
    HttpReader { method: ReaderMethod::Get, path: "/api/decisions", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_list_decisions", evidence: "MemoryItem.content, MemoryItem.source_text, MemoryItem.summary, Me" },
    ...
    HttpReader { method: ReaderMethod::Get, path: "/api/home-stats", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_get_home_stats", evidence: "TopMemory.content" },
    ...
    HttpReader { method: ReaderMethod::Get, path: "/api/indexed-files", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_list_indexed_files", evidence: "IndexedFileInfo.content, IndexedFileInfo.summary, IndexedFileInfo." },
    ...
    HttpReader { method: ReaderMethod::Get, path: "/api/memory/by-ids", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_get_memories_by_ids", evidence: "MemoryItem.content, MemoryItem.source_text, MemoryItem.summary, Me" },
    ...
    HttpReader { method: ReaderMethod::Get, path: "/api/memory/entities/{entity_id}", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_get_entity_detail", evidence: "Observation.content" },
    ...
    HttpReader { method: ReaderMethod::Post, path: "/api/memory/list", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_list_memories", evidence: "IndexedFileInfo.content, IndexedFileInfo.summary, IndexedFileInfo." },
    HttpReader { method: ReaderMethod::Get, path: "/api/memory/nurture", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_get_nurture_cards", evidence: "MemoryItem.content, MemoryItem.source_text, MemoryItem.summary, Me" },
    ...
    HttpReader { method: ReaderMethod::Get, path: "/api/memory/pending-revision/{source_id}", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_get_pending_revision", evidence: "PendingRevision.content" },
    HttpReader { method: ReaderMethod::Get, path: "/api/memory/pending-revisions", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_list_pending_revisions", evidence: "PendingRevisionItem.revision_content" },
    HttpReader { method: ReaderMethod::Get, path: "/api/memory/pinned", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_list_pinned_memories", evidence: "MemoryItem.content, MemoryItem.source_text, MemoryItem.summary, Me" },
    HttpReader { method: ReaderMethod::Get, path: "/api/memory/recent", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_recent_memories", evidence: "RecentActivityItem.snippet, RecentActivityItem.title" },
    ...
    HttpReader { method: ReaderMethod::Get, path: "/api/memory/rejections", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_get_rejections", evidence: "RejectionRecord.content" },
    ...
    HttpReader { method: ReaderMethod::Get, path: "/api/memory/unconfirmed", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_list_unconfirmed_memories", evidence: "RecentActivityItem.snippet, RecentActivityItem.title" },
    ...
    HttpReader { method: ReaderMethod::Get, path: "/api/memory/{id}/detail", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_get_memory_detail", evidence: "MemoryItem.content, MemoryItem.source_text, MemoryItem.summary, Me" },
    ...
    HttpReader { method: ReaderMethod::Get, path: "/api/memory/{id}/revisions", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_get_memory_revisions", evidence: "MemoryRevisionEntry.content_preview, MemoryRevisionEntry.delta_sum" },
    ...
    HttpReader { method: ReaderMethod::Get, path: "/api/memory/{id}/versions", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_get_version_chain", evidence: "MemoryVersionItem.content, MemoryVersionItem.title" },
    HttpReader { method: ReaderMethod::Get, path: "/api/memory/{source_id}/enrichment-status", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_get_enrichment_status", evidence: "EnrichmentStatusResponse.summary" },
    ...
    HttpReader { method: ReaderMethod::Get, path: "/api/profile/narrative", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_get_profile_narrative", evidence: "NarrativeResponse.content" },
    HttpReader { method: ReaderMethod::Post, path: "/api/profile/narrative/regenerate", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_regenerate_narrative", evidence: "NarrativeResponse.content" },
    ...
    HttpReader { method: ReaderMethod::Get, path: "/api/snapshots", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_list_snapshots", evidence: "SessionSnapshot.summary" },
    HttpReader { method: ReaderMethod::Get, path: "/api/snapshots/{id}/captures", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_get_snapshot_captures", evidence: "SnapshotCapture.window_title" },
    HttpReader { method: ReaderMethod::Get, path: "/api/snapshots/{id}/captures-with-content", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_get_snapshot_captures_with_content", evidence: "SnapshotCaptureWithContent.content, SnapshotCaptureWithContent.sum" },
    ...
    HttpReader { method: ReaderMethod::Get, path: "/api/spaces", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_list_spaces", evidence: "Space.description" },
    HttpReader { method: ReaderMethod::Post, path: "/api/spaces", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_create_space", evidence: "Space.description" },
    ...
    HttpReader { method: ReaderMethod::Get, path: "/api/spaces/default", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_get_default_space", evidence: "Space.description" },
    HttpReader { method: ReaderMethod::Put, path: "/api/spaces/default", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_set_default_space", evidence: "Space.description" },
    ...
    HttpReader { method: ReaderMethod::Put, path: "/api/spaces/{name}", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_update_space", evidence: "Space.description" },
    ...
    HttpReader { method: ReaderMethod::Get, path: "/ws/updates", builder: Builder::Main, page_bearing: PageBearing::No, class: TruthClass::NotApplicable, marker_shape: MarkerShape::None, adapter: "—", evidence: "DEMOTED, see below" },
];
...
pub const CLI_READERS: &[CliReader] = &[
    ...
    CliReader { subcommand: "wenlan pages", page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::CollectionAndNamedPage, adapter: "subcommand renderer" },
