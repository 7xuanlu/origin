...
pub const HTTP_READERS: &[HttpReader] = &[
    ...
    HttpReader { method: ReaderMethod::Get, path: "/api/memory/graph", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_get_knowledge_graph", evidence: "GraphMemoryNode.title via dismissed card" },
