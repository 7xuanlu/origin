...
pub const HTTP_READERS: &[HttpReader] = &[
    ...
    HttpReader { method: ReaderMethod::Post, path: "/api/pages/drafts", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_create_page_draft", evidence: "PageDraftResponse.page — echoes the caller's own draft snapshot" },
    HttpReader { method: ReaderMethod::Put, path: "/api/pages/drafts/{id}", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_update_page_draft", evidence: "PageDraftResponse.page — echoes the caller's own draft snapshot" },
    ...
    HttpReader { method: ReaderMethod::Post, path: "/api/pages/drafts/{id}/publish", builder: Builder::Main, page_bearing: PageBearing::Yes, class: TruthClass::Automatic, marker_shape: MarkerShape::None, adapter: "handle_publish_page_draft", evidence: "PageDraftResponse.page — echoes the caller's own draft snapshot" },
